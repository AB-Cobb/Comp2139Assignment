    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style4">
                <asp:ListBox ID="lstbContactList" runat="server" AutoPostBack="True" Rows="8" Width="400px"></asp:ListBox>
            </td>
        ...
        <tr>
            <td class="auto-style3">
                <asp:Button ID="btnDisplayContactList" runat="server" CausesValidation="False" Text="Display Contact List" PostBackUrl="~/Customers.aspx"/>
            </td>
            <td class="auto-style5">&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
