<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewSurvey.aspx.cs" Inherits="Comp2139Assignment.ViewSurvey1" %>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style4">Select A Customer:&nbsp;&nbsp;
                <asp:DropDownList ID="ddlCustomers" runat="server" Width="200px">
                </asp:DropDownList>
            </td>
        ...
        <tr>
            <td colspan="2">
                <asp:ListBox ID="lstbSurvey" runat="server" Rows="8" Width="600px"></asp:ListBox>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td class="auto-style3">
                <asp:Button ID="btnRetrieveSurveyDetails" runat="server" Text="Retrieve Survey Details" />
            </td>
            <td class="auto-style5">&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
            <td class="auto-style3">Respose Time:</td>
            <td class="auto-style5">Contact to Discuss Incident:</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td class="auto-style3">&nbsp;</td>
        ...
        <tr>
            <td class="auto-style3">Techician Efficiency: </td>
        ...
        <tr>
            <td class="auto-style3">Problem Resolution: </td>
            <td class="auto-style5">&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auto-style3">Additional Comments:</td>
            <td class="auto-style5">&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
